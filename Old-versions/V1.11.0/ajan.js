(function() {
    ...
    EventTarget.prototype.addEventListener = function(type, listener, options) {
        ...
        if (["visibilitychange", "blur", "pagehide"].includes(type)) {
            ...
            const safeListener = function(e) {
                // 🔥 Sadece tarayıcı izin veriyorsa (cancelable ise) varsayılanı engelle.
                // Aksi takdirde preventDefault pasif dinleyicilerde kodun çökmesine neden olur.
                if (e.cancelable) {
                    e.preventDefault();
                }
                // Asıl oyunu kör eden komutlar bunlar, hatasız çalışmaları şart:
                e.stopPropagation();
                e.stopImmediatePropagation();
            };

            // 🔥 Oyun motoru passive: true yolluyorsa onu ezip false yapıyoruz ki preventDefault patlamasın.
            let safeOptions = options;
            if (typeof options === 'object' && options !== null) {
                safeOptions = { ...options, passive: false };
            }

            return originalAddEventListener.call(this, type, safeListener, safeOptions);
        }
    ...
    // Botun soketi tanıması için prototype zincirini onarıyoruz
